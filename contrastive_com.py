...
-- COMPOSITE-INLINED VARIANT (self-contained, no external cluster_composite.py)

Identical to contrastive.py except the composite-map generation is inlined
at module level instead of imported from cluster_composite. Useful when
you want a single-file training + composite pipeline for portability.
