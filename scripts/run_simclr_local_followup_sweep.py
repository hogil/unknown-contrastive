#!/usr/bin/env python3
"""Follow-up sweep around the best local/queue SimCLR setting."""
...
OUT_CSV = DOC_DIR / "SIMCLR_LOCAL_FOLLOWUP_WITH_BASELINES.csv"
OUT_MD = DOC_DIR / "SIMCLR_LOCAL_FOLLOWUP_WITH_BASELINES.md"
...
CONDITIONS: list[dict[str, Any]] = [
    {
        "stage": "L0",
        "name": "queue2048_local_w0p15",
        "method": "queue2048+ignore0.70+local_w0.15",
        "args": local_args("2048", "0.70", "0.15"),
    },
    {
        "stage": "L1",
        "name": "queue2048_local_w0p25",
        "method": "queue2048+ignore0.70+local_w0.25",
        "args": local_args("2048", "0.70", "0.25"),
    },
    {
        "stage": "L2",
        "name": "queue2048_local_ignore0p60",
        "method": "queue2048+ignore0.60+local_w0.20",
        "args": local_args("2048", "0.60", "0.20"),
    },
    {
        "stage": "L3",
        "name": "queue2048_local_ignore0p80",
        "method": "queue2048+ignore0.80+local_w0.20",
        "args": local_args("2048", "0.80", "0.20"),
    },
    {
        "stage": "L4",
        "name": "queue3072_local_w0p2",
        "method": "queue3072+ignore0.70+local_w0.20",
        "args": local_args("3072", "0.70", "0.20"),
    },
    {
        "stage": "L5",
        "name": "queue4096_local_w0p2",
        "method": "queue4096+ignore0.70+local_w0.20",
        "args": local_args("4096", "0.70", "0.20"),
    },
    {
        "stage": "L6",
        "name": "queue2048_local_temp006",
        "method": "temp0.06+queue2048+ignore0.70+local_w0.20",
        "nce_temp": "0.06",
        "args": local_args("2048", "0.70", "0.20"),
    },
    {
        "stage": "L7",
        "name": "queue2048_local_lrb1e6",
        "method": "lr_backbone1e-6+queue2048+ignore0.70+local_w0.20",
        "lr_backbone": 1e-6,
        "args": local_args("2048", "0.70", "0.20"),
    },
    {
        "stage": "L8",
        "name": "queue2048_local_lrb3e6",
        "method": "lr_backbone3e-6+queue2048+ignore0.70+local_w0.20",
        "lr_backbone": 3e-6,
        "args": local_args("2048", "0.70", "0.20"),
    },
    {
        "stage": "L9",
        "name": "queue2048_local_ep8",
        "method": "epoch8+queue2048+ignore0.70+local_w0.20",
        "epochs": 8,
        "args": local_args("2048", "0.70", "0.20"),
    },
]
...
def write_outputs(rows: list[dict[str, Any]], baseline_rows: list[dict[str, Any]], classes: list[str]) -> None:
    ...
    with OUT_MD.open("w", encoding="utf-8") as f:
        f.write("# SimCLR Local Follow-up With Baselines\n\n")
