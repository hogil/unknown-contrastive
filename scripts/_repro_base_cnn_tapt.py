#!/usr/bin/env python3
"""May-style repro: base contrastive with CNN/TAPT initialization."""
...
SRC = Path(__file__).with_name("_repro_base_nocnn.py")
TAPT_CKPT = "D:/project/known-cnn/models/iter116J_frozen/best_model.pth"

spec = importlib.util.spec_from_file_location("_repro_base_nocnn_mod", SRC)
mod = importlib.util.module_from_spec(spec)
assert spec and spec.loader
sys.modules[spec.name] = mod
spec.loader.exec_module(mod)

mod.TAG = "base_cnn_tapt"
