...
CONFIGS=(
  ...
  "unkda_nv097|--method simclr --nv-filter 0.97|$DA_TR|$DA_EXCL|defect-aware strict novel + NV 0.97|8"
  "unkda_nv098|--method simclr --nv-filter 0.98|$DA_TR|$DA_EXCL|defect-aware strict novel + NV 0.98|8"
  "unkda_nv099|--method simclr --nv-filter 0.99|$DA_TR|$DA_EXCL|defect-aware strict novel + NV 0.99|8"
  "unkda_nv085|--method simclr --nv-filter 0.85|$DA_TR|$DA_EXCL|defect-aware strict novel + NV 0.85|8"
